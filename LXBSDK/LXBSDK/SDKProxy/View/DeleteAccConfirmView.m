...
- (void)initButtomBtn{
    ...
    left.backgroundColor = [LXBHelper btnBGColor];
    ...
    right.backgroundColor = [LXBHelper btnBGColor];
    ...
    confirmTxt.textColor = [UIColor grayColor];
    confirmTxt.font = [UIFont systemFontOfSize:UI(16)];
